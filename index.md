...
venue: "MIND INSTITUTE"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Room 2434, 2805 50th Street, Sacramento, CA 95817"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Brad Ander"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["junebug and little C"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<h4>I CAN CHANGE THIS TEXT  **********This is the workshop template. Delete these lines and use it to customize your own website.
...
{% comment %}
  ...
  Come one come all, Explain who your audience is.  (In particular, tell readers if the
